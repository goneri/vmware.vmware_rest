...
def prepare_argument_spec():
    ...
    argument_spec["~action"] = {
        "type": "str",
        "choices": ["list-attached-tags-on-objects"],
        "operationIds": [
            "attach_tag_to_multiple_objects",
            "list_attached_tags_on_objects",
        ],
...
async def _attach(params, session):
    ...
    async with session.post(_url, json={"spec": spec}) as resp:
        try:
            ...
            _json = {}
        if ("attach" == "create") and ("value" in _json):
...
async def _attach_multiple_tags_to_object(params, session):
    ...
    async with session.post(_url, json={"spec": spec}) as resp:
        try:
            ...
            _json = {}
        if ("attach_multiple_tags_to_object" == "create") and ("value" in _json):
            if type(_json["value"]) == dict:
                _id = list(_json["value"].values())[0]
            else:
                _id = _json["value"]
...
async def _attach_tag_to_multiple_objects(params, session):
    ...
    async with session.post(_url, json={"spec": spec}) as resp:
        try:
            ...
            _json = {}
        if ("attach_tag_to_multiple_objects" == "create") and ("value" in _json):
            if type(_json["value"]) == dict:
                _id = list(_json["value"].values())[0]
            else:
                _id = _json["value"]
...
async def _detach(params, session):
    ...
    async with session.post(_url, json={"spec": spec}) as resp:
        try:
            ...
            _json = {}
        if ("detach" == "create") and ("value" in _json):
            if type(_json["value"]) == dict:
                _id = list(_json["value"].values())[0]
            else:
                _id = _json["value"]
...
async def _detach_multiple_tags_from_object(params, session):
    ...
    async with session.post(_url, json={"spec": spec}) as resp:
        try:
            ...
            _json = {}
        if ("detach_multiple_tags_from_object" == "create") and ("value" in _json):
            if type(_json["value"]) == dict:
                _id = list(_json["value"].values())[0]
            else:
                _id = _json["value"]
...
async def _detach_tag_from_multiple_objects(params, session):
    ...
    async with session.post(_url, json={"spec": spec}) as resp:
        try:
            ...
            _json = {}
        if ("detach_tag_from_multiple_objects" == "create") and ("value" in _json):
            if type(_json["value"]) == dict:
                _id = list(_json["value"].values())[0]
            else:
                _id = _json["value"]
...
async def _list_attachable_tags(params, session):
    ...
    async with session.post(_url, json={"spec": spec}) as resp:
        try:
            ...
            _json = {}
        if ("list_attachable_tags" == "create") and ("value" in _json):
            if type(_json["value"]) == dict:
                _id = list(_json["value"].values())[0]
            else:
                _id = _json["value"]
...
async def _list_attached_objects_on_tags(params, session):
    ...
    async with session.post(_url, json={"spec": spec}) as resp:
        try:
            ...
            _json = {}
        if ("list_attached_objects_on_tags" == "create") and ("value" in _json):
            if type(_json["value"]) == dict:
                _id = list(_json["value"].values())[0]
            else:
                _id = _json["value"]
...
async def _list_attached_tags(params, session):
    ...
    async with session.post(_url, json={"spec": spec}) as resp:
        try:
            ...
            _json = {}
        if ("list_attached_tags" == "create") and ("value" in _json):
            if type(_json["value"]) == dict:
                _id = list(_json["value"].values())[0]
            else:
                _id = _json["value"]
...
async def _list_attached_tags_on_objects(params, session):
    ...
    async with session.post(_url, json={"spec": spec}) as resp:
        try:
            ...
            _json = {}
        if ("list_attached_tags_on_objects" == "create") and ("value" in _json):
            if type(_json["value"]) == dict:
                _id = list(_json["value"].values())[0]
            else:
                _id = _json["value"]
