...
DOCUMENTATION = "author:\n- Ansible VMware team\ndescription: Handle resource of type vcenter_vm_tools_installer\nextends_documentation_fragment: []\nmodule: vcenter_vm_tools_installer\nnotes:\n- Tested on vSphere 7.0\noptions:\n  action:\n    choices:\n    - disconnect\n    description:\n    - action=disconnect Required with I(state=['disconnect'])\n    type: str\n  state:\n    choices:\n    - connect\n    - disconnect\n    description: []\n    type: str\n  vm:\n    description:\n    - 'Virtual machine ID\n\n      The parameter must be an identifier for the resource type: VirtualMachine.'\n    type: str\nrequirements:\n- python >= 3.6\nshort_description: Handle resource of type vcenter_vm_tools_installer\nversion_added: 1.0.0\n"
...
def prepare_argument_spec():
    ...
    argument_spec["vm"] = {"type": "str", "operationIds": ["connect", "disconnect"]}
    argument_spec["state"] = {"type": "str", "choices": ["connect", "disconnect"]}
    argument_spec["action"] = {
        "type": "str",
        "choices": ["disconnect"],
        "operationIds": ["disconnect"],
    }
...
def url(params):
    return "https://{vcenter_hostname}/rest/vcenter/vm/{vm}/tools/installer".format(
        **params
    )
